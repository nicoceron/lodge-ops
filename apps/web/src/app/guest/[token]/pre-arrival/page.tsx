    ...
    <>
      <div className={styles.pageHeader}>
        <div>
          ...
          <h1 className={styles.pageTitle}>Help us prepare around you</h1>
          <p className={styles.pageDescription}>One calm form covers contact, travel, dining, accessibility and essential consent details. Save it whenever your plans become firm.</p>
        </div>
        <span className={styles.statusPill}><ClipboardCheck aria-hidden="true" size={14} /> About 4 minutes</span>
      </div>
      <section className={`${styles.card} ${styles.cardPadding}`}>
        <PreArrivalForm />
      </section>
    </>
  );
