...
class DashboardController extends Controller
{
    public function __invoke(
        ...
        return response()->json([
            'data' => [
                ...
                'arrival_parties' => $arrivals->map(fn (Reservation $reservation) => $this->arrival($reservation, $visibility))->values(),
                'readiness' => [
    ...
    private function arrival(Reservation $reservation, StaffProjectionVisibility $visibility): array
    {
        ...
        $arrival = [
            ...
            'nights' => max(1, $reservation->starts_at->diffInDays($reservation->ends_at)),
            'readiness' => $readiness,
