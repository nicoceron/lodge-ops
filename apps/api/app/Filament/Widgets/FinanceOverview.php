    ...
    protected function getStats(): array
    {
        ...
        return [
            ...
            Stat::make('Gross margin', $format($summary['margin_minor']))
                ->description($summary['margin_percent'].'% margin after costs')
                ->descriptionIcon($summary['margin_minor'] >= 0 ? 'heroicon-m-arrow-trending-up' : 'heroicon-m-arrow-trending-down')
                ->color($summary['margin_minor'] >= 0 ? 'success' : 'danger'),
        ];
    }
