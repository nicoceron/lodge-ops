    ...
    public static function configure(Schema $schema): Schema
    {
        return $schema->components([
            Section::make('Stay summary')->columns(3)->schema([
                ...
                TextEntry::make('primary_guest')
                    ...
                    ->state(fn (Reservation $record): string => $record->primaryGuest
                        ...
                        : 'Unassigned'),
                TextEntry::make('starts_at')->label('Arrival')->dateTime('M j, Y · H:i', timezone: InnPresentation::timezone()),
                TextEntry::make('ends_at')->label('Departure')->dateTime('M j, Y · H:i', timezone: InnPresentation::timezone()),
                TextEntry::make('hold_expires_at')->label('Hold expires')->dateTime('M j, Y · H:i', timezone: InnPresentation::timezone())->placeholder('Not a held quote'),
                TextEntry::make('actual_start_at')->label('Checked in')->dateTime('M j, Y · H:i', timezone: InnPresentation::timezone())->placeholder('Not checked in'),
                TextEntry::make('actual_end_at')->label('Checked out')->dateTime('M j, Y · H:i', timezone: InnPresentation::timezone())->placeholder('Not checked out'),
            ...
            Section::make('Folio summary')->columns(4)->schema([
                TextEntry::make('folio_status')->label('Status')->badge()->formatStateUsing(InnPresentation::label(...)),
                ...
                TextEntry::make('folio_balance')
                    ...
                    ->weight('bold'),
                TextEntry::make('folio_closed_at')->label('Closed at')->dateTime('M j, Y · H:i', timezone: InnPresentation::timezone())->placeholder('Open'),
