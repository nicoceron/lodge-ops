    ...
    public static function configure(Schema $schema): Schema
    {
        return $schema->components([
            Section::make('Deposit')->columns(2)->schema([
                ...
                TextEntry::make('due_at')->label('Due')->dateTime('M j, Y · H:i', timezone: LodgeOpsPresentation::timezone())->placeholder('On request'),
                TextEntry::make('payment.provider_reference')->label('Payment reference')->placeholder('Not paid')->copyable(),
                TextEntry::make('paid_at')->label('Paid')->dateTime('M j, Y · H:i', timezone: LodgeOpsPresentation::timezone())->placeholder('Not paid'),
