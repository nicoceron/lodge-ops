        ...
        return $schema->components([
            Section::make('Immutable payment record')
                ...
                ->schema([
                    ...
                    TextEntry::make('origin')->badge()->formatStateUsing(InnPresentation::label(...)),
                    TextEntry::make('provider')->label('External processor')->placeholder('Not recorded'),
                    TextEntry::make('provider_reference')->label('External reference')->copyable()->placeholder('Not provided'),
